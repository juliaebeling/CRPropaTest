...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_crpropa')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_crpropa')
    _crpropa = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_crpropa', [dirname(__file__)])
        except ImportError:
            import _crpropa
            return _crpropa
        if fp is not None:
            try:
                _mod = imp.load_module('_crpropa', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _crpropa = swig_import_helper()
    ...
    import _crpropa
# pull in all the attributes from _crpropa
if __name__.rpartition('.')[0] != '':
    if _swig_python_version_info >= (2, 7, 0):
        try:
            from ._crpropa import *
        except ImportError:
            from _crpropa import *
    else:
        from _crpropa import *
